...
return [
    ...
    'providers' => [
        ...
        // Google Vertex AI (rmh/vertex). Standard mode needs project_id + location
        // + a service-account JSON path in 'credentials'. Omit project_id/location
        // and set 'api_key' instead to use Vertex Express mode (Gemini only).
        'vertex' => [
