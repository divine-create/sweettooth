                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="{{ $stock['is_expired'] ? 'bg-red-50 dark:bg-red-900/20' : '' }}">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <input type="number"
                                        ...
                                        step="0.01"
                                        class="w-20 px-2 py-1 text-sm border dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                        {{ $isVerified ? 'disabled' : '' }}>
                                </td>
                                <td class="px-4 py-3 text-sm font-semibold {{ $stock['variance'] == 0 ? 'text-green-600' : 'text-red-600' }}">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    <span class="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300">Variance</span>
                                    @else
