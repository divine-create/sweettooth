        ...
        @else
            <div class="flex items-center justify-between p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                <div class="flex items-center gap-2 text-yellow-800 dark:text-yellow-300">
                    ...
                    <p class="font-medium">No open accounting period for {{ now()->format('F Y') }}. GL entries cannot be posted.</p>
                </div>
                <a href="{{ route('branch-dashboard.accounting.periods') }}"
                   class="ml-4 flex-shrink-0 px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white text-sm font-semibold rounded-lg">
                    Manage Periods
                </a>
            </div>
        @endif
