<div class="space-y-6">
    <div class="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">Inventory</p>
                <h1 class="mt-2 text-3xl font-semibold text-zinc-900 dark:text-white">Reports</h1>
                <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">Browse and review generated inventory reports.</p>
            </div>
        </div>
    </div>
            ...
            <div class="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                            {{ $report->department?->name ?? 'Inventory' }}
                        </p>
                    </div>
                ...
                <div class="mt-4 flex items-center gap-2">
                    <a class="rounded-full border border-zinc-200 px-3 py-1 text-xs font-semibold text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-800"
                       href="{{ branch_route('branch-dashboard.inventory.reports.show', ['id' => $report->id, 'b_id' => $b_id]) }}">
                        View
                    </a>
                    <a class="rounded-full border border-zinc-200 px-3 py-1 text-xs font-semibold text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-800"
